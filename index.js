...
// setInterval(()=>{     MAVParser.createMessage('HEARTBEAT',{         'type' :
// 6,         'autopilot' : 8,         'base_mode' : 192,         'custom_mode'
// : 0,         'system_status' : 4,         'mavlink_version' : 3
// },(message)=>{         socket.emit('server',message.buffer)     }); },100);